...
from src.web.controller.board_controller import PostController
import pandas as pd
...
controller = PostController('127.0.0.1', 'root', '1234', 'doctoro')
posts = controller.get_posts()  # 게시글 가져오기
# print(posts)  # 게시글 내용을 출력
controller.close_connection()  # 연결 닫기
