...
def first_city_model():
    df1 = pd.read_csv("./service/vote_record_first_list.csv", encoding="utf-8", index_col=0)
...
def second_city_model():
    df2 = pd.read_csv("./service/vote_record_second_list.csv", encoding="utf-8", index_col=0)
...
def third_city_model():
    ...
    df3 = pd.read_csv("./service/vote_record_third_list.csv", encoding="utf-8", index_col=0)
